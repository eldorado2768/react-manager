...
const AuthForm = ({ supabase, onLoginSuccess, onSignUpClick, onForgotPasswordClick }) => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            setAlert({ message: error.message || 'Login failed. Please try again.', type: 'error' });
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <div className="glass-effect rounded-2xl p-4 shadow-2xl"> {/* p-4 instead of p-8 for Bootstrap spacing */}
            <Form onSubmit={handleLogin}>
                ...
                <Form.Group className="mb-3" controlId="formPassword">
                    <Form.Label className="block text-white text-sm font-medium mb-2">Password</Form.Label>
                    <InputGroup> {/* Use InputGroup for appending eye icon */}
                        <Form.Control
                ...
                <div className="position-relative mb-3">
                    <hr className="text-white-50 opacity-25" /> {/* Bootstrap hr with opacity */}
